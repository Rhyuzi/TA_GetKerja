					...
					<div class="card-body">
						<form action="<?php base_url(" admin/product/ubah" .$tbl_record_perusahaan->noid) ?>" method="post"
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" name="input_provinsi" value="<?php echo set_value('input_kota', $tbl_record_perusahaan->provinsi); ?>">
							...
							<input class="btn btn-success" type="submit" name="submit" value="Ubah">
							 ...
							 <a href="<?php echo site_url('admin/lowongan/') ?>">
